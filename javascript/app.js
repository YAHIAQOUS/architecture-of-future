...
function getInterest(userInterest) {
...
getFavouriteArchitect(favouriteArchitect)

function getFavouriteArchitect(userFavouriteArchitect) {
    ...
    if (favouriteArchitect == 'zaha hadid') {
        favouriteArchitectImage = '<img src= "https://i.guim.co.uk/img/media/2ca852576b9037530ae9885e68a7014dc7e09241/315_0_4185_2511/master/4185.jpg?width=620&quality=85&auto=format&fit=max&s=01034753f1f9719c623f5ec4a320d6f8"  width=300px /> </br>';

    } else if (favouriteArchitect = 'norman foster') { favouriteArchitectImage = '<img src= "https://www.archoutloud.com/uploads/4/8/0/4/48046731/0361-fp5387_1_orig.jpg" width=300px /> </br>'; }
}
